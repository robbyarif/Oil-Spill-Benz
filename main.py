...
def main():
    ...
    # # yolov11_path = f"{exp_checkpoint_base_path}/yolov11-exp2.2-port-oil2/weights/best.pt"
    ...
    # # trainer_yolo11.test(src, dst="runs/test/exp2.2_port-oil-split/yolov11", save=True, file_name="val.txt", color_coded=True)

    # trainer_yolo12 = YoloTrainer()
    # yolov12_path = f"{exp_checkpoint_base_path}/yolov12-exp2.2-port-oil/weights/best.pt"
    ...
    # trainer_yolo12.test(src, dst="runs/test/exp2.2_port-oil-split/yolo12", save=True, file_name="val.txt", color_coded=True)

    # # trainer_deeplab = DeeplabTrainer()
    # # deeplab_path = f"{exp_checkpoint_base_path}/deeplabv3-exp2.2-port-oil/weights/last.pt"
    ...
    # # trainer_deeplab.test(src, dst="runs/test/exp2.2_port-oil-split/deeplabv3", save=True, file_name="val.txt", color_coded=True)

    # trainer_segformer = SegformerTrainer()
    # segformer_path = f"{exp_checkpoint_base_path}/segformer-exp2.2-port-oil/weights/last.pt"
    ...
    # trainer_segformer.test(src, dst="runs/test/exp2.2_port-oil-split/segformer", save=True, file_name="val.txt", color_coded=True)
